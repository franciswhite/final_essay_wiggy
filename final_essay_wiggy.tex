...
\paragraph{Peter Hacker}\footcite{This section is based on }%cite Hacker
...
\end{quote}
 Also, Wittgenstein adopts the term ''savages'' throughout his remarks on Frazer - albeit he seems to do so reluctantly. Some commentators have suggested that this is part of a an attempt to re-coin the disparaging term or an ironic usage of it. (cf. %\cite{luckhardt1979wittgenstein})
