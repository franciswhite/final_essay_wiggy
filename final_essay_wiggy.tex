...
\begin{quote}
The basic form of the game can't include doubt. What we are doing here above all is to imagine a basic form: a possibility, indeed a very important possibility. (We very often confuse what is an important possibility with historical reality.) %\cite{wittgenstein1976cause}, p. 411
\end{quote}
...
\end{quote} %\cite{luckhardt1979wittgenstein}, p. 61
...
\begin{quote}
One sees how misleading Frazer's explanations are [...] by noting that one could very easily invent primitive practices oneself, and it would be pure luck if they were not actually found somewhere. %\cite{luckhardt1979wittgenstein}, p. 65
\end{quote} 
...
\begin{quote}
That is, the principle according to which these practices are arranged is a much more general one than in Frazer's explanation and it is present in our own minds, so that we ourselves could think up all the possibilities. %\cite{luckhardt1979wittgenstein}, p. 65-66
\end{quote} 
